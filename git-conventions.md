...
## Projects
If you are using Projects, you should open an issue for every story (unless there won't be any code pushed to complete it). Your story and issue will then be linked and you can update either—both will update automatically. You can also set automations for your workflow, like moving a story to `Done` after a pull request.
